...
namespace BookCrud.Controllers
{
    ...
    {
        private readonly BookCrudContext _context;

        public LivroesController(BookCrudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Livro != null ? 
                          ...
                          Problem("Entity set 'BookCrudContext.Livro'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookCrudContext.Livro'  is null.");
            }
            var livro = await _context.Livro.FindAsync(id);
            if (livro != null)
            {
